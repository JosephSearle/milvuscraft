    ...
    rules:
      - alert: MilvusSearchLatencyHigh
        ...
        annotations:
          ...
          description: "Run milvuscraft-diagnostics → Branch A"
      ...
      - alert: MilvusCompactionBacklogHigh
        ...
        annotations:
          ...
          description: "Reduce delete rate or trigger manual compact (milvuscraft-lifecycle-compaction-ttl)"
      ...
      - alert: MilvusInsertLatencyHigh
        ...
        annotations:
          ...
          description: "Check batch sizing in milvuscraft-data-ingestion"
```
